...
const CONTACTS = [
  {
    label: 'Email',
    value: 'pauperformance@gmail.com',
    href: 'mailto:pauperformance@gmail.com',
    icon: 'M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z',
  },
  {
    label: 'Twitch',
    value: 'pauperformance',
    href: 'https://www.twitch.tv/pauperformance',
  ...
  },
  {
    label: 'YouTube',
    value: 'Pauperformance',
    href: 'https://www.youtube.com/channel/UCDUiIskNnmuJ3XJ1SdQqs0A',
  ...
  },
  {
    label: 'Instagram',
    value: 'pauperformance',
    href: 'https://www.instagram.com/pauperformance/',
  ...
  {
    label: 'Discord',
    value: 'Pauperformance server',
    href: 'https://discord.gg/fYQbpjjkQ3',
  ...
  },
  {
    label: 'Twitter / X',
    value: '@pauperformance',
    href: 'https://twitter.com/pauperformance',
  ...
  },
  {
    label: 'Telegram',
    value: 'pauperformance',
    href: 'https://telegram.me/pauperformance',
  ...
  },
  {
    label: 'GitHub',
    value: 'Pauperformance',
    href: 'https://github.com/Pauperformance',
    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-gray-400 text-sm">You can find us on different platforms. Feel free to reach us where you prefer!</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {CONTACTS.map(({ label, value, href, icon }) => (
            <a
              ...
              rel="noreferrer"
              className="flex items-center gap-4 bg-gray-800 border border-gray-700 rounded-xl p-4 hover:border-amber-400/50 hover:bg-gray-750 transition-colors group">
              <div className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center shrink-0 group-hover:bg-amber-400/10 transition-colors">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-gray-400 group-hover:text-amber-400 transition-colors">
                  <path d={icon} />
                </svg>
              </div>
              <div className="min-w-0">
                <p className="text-xs text-gray-500 mb-0.5">{label}</p>
                <p className="text-sm text-gray-200 group-hover:text-amber-300 transition-colors truncate">{value}</p>
              </div>
            </a>
          ))}
        </div>
